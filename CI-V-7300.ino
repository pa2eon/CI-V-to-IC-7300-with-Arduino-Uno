...
// RX = Icom radio to Arduino  : to pin 0 via resistor 4k7
// TX = Arduino to Icom radio  : to pin 1 via diode 1N4148, with pull up 10k to Vcc (5V) on tip of 3.5 mm connector
...
pinMode(0, INPUT);   // CI-V serial communication from IC7300
pinMode(1, OUTPUT); // CI-V serial communication to IC7300
